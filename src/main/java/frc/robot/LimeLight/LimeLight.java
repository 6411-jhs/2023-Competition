...
public class LimeLight extends SubsystemBase {
   ...
   public CommandBase follow(){
      return runOnce(() -> {
         // System.out.println(getVerticalSpeed(0, 0.75));
         // drive.arcadeDrive(0, getHorizontalTurn(0.25, 0.7));
         
         // double params[] = {getVerticalSpeed(0, 0.75), getHorizontalTurn(0.25, 0.7)};
   ...
   private double getVerticalSpeed(double minSpeed, double maxSpeed){
      double value = ((maxSpeed - minSpeed) / 20.5) * y;
